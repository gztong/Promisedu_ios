...
public class CourseDashboardViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    public override func viewDidLoad() {
        ...
        let evc = GZTEnrollViewController()
...
//    }
    ...
    public func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0{
            ...
            var cell = GZTProgressCell(style: UITableViewCellStyle.Default, reuseIdentifier: "GZTProgressCell")
    ...
    public func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        if indexPath.section == 1{
            let vc = GZTPaymentViewController()
